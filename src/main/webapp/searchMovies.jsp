		...
		<div class="container">
			...
			<div class="row">
					...
					<div class="col">
						<div class="card">
						  <div class="card-body">
	    					...
	    					<div class="container">
								<form method="POST" action="searchMoviesByType">
				...
				<div class="col">
					<div class="card">
					  <div class="card-body">
    					...
    					<div class="container">
							<form method="POST" action="searchMoviesByName">
				...
				<div class="col">
					<div class="card">
					  <div class="card-body">
					    <h5 class="card-title">Search by Actor</h5>
    					<div class="container">
							<form method="POST" action="searchMoviesByActor">
								<label for="actorName">Actor Name:</label>
	    						<input type="text" class="form-control" id="actorName" name="actorName" placeholder="Type Actor Name or a Part of it">
								<input type="submit" value="Search" class="btn btn-primary"/>
							</form>
						</div>
					  </div>
